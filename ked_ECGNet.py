...
#一个1D残差块。包含三层卷积和BN，带SE通道注意力机制，支持残差连接。
...
class ECGNet(nn.Module):
    def __init__(self, input_channel=1, num_classes=5, use_ecgNet_Diagnosis="ecgNet"):
        ...
        self.relu = nn.ReLU()
        #首层卷积将12导联信号（(batch, 1, 12, L)）映射到32通道，后续继续卷积和归一化。
